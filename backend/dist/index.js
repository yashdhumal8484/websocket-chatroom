...
const outgoingMesssages_1 = require("./messages/outgoingMesssages");
...
function messageHandler(ws, message) {
    ...
    if (message.type === incomingMessages_1.SupportedMessage.SendMessage) {
        ...
        const outgoingPayload = {
            type: outgoingMesssages_1.SupportedMessage.AddChat,
            payload: {
                chatId: chat.id,
    ...
    if (message.type === incomingMessages_1.SupportedMessage.UpvoteMessage) {
        ...
        const outgoingPayload = {
            type: outgoingMesssages_1.SupportedMessage.UpdateChat,
            payload: {
